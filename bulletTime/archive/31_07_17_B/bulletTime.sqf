...
{           
            ...
            nul = call compile preprocessFileLineNumbers "apply_tracer.sqf";
        sleep 0.1;
            ...
            chromAb =  ["ChromAberration", 1000, [0.03, 0.02, true]] call compile preprocessFileLineNumbers "chromAb.sqf";
        ...
        sleep 3;
            if (missionNamespace getvariable ["bTimeActive",true]) then { playSound3D ["sounds\powerup.wav", player, false, getPosASL player, 5, 1, 0]; };
            player setAnimSpeedCoef 1.67;
            setAccTime 0.6; 
        ...
        sleep 0.33;
            ...
            {  nul = call compile preprocessFileLineNumbers  "resetAmmo.sqf";  };
